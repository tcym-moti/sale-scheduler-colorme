...
type Preview = { pricingMode: "FIXED" | "DISCOUNT_RATE"; value: number; startAt: string; endAt: string; items: PreviewItem[]; valid: boolean };
...
export default function Dashboard({ shopName, accountId }: { shopName: string; accountId: string }) {
  ...
  return <div className="shell">
    ...
    <main className="main">
      ...
      <p className="footer-note">価格変更の監査ログを保存します。Conflict時は商品価格を変更せず、人間の確認を待ちます。</p>
    </main>
  </div>;
}
